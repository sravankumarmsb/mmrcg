# -*- coding: utf-8 -*-
"""mmrcs_clippretrained_flickr8k.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19WCnbNWyVhh_ZQ4AwCGUhOWWEp0Ixw8j
"""
...
images_path = os.path.join(base_path, "flickr8k_images")
captions_file = os.path.join(base_path, "captions.txt")
images_embeddings_file = os.path.join(base_path, "8k_pretrain_image_embeddings.pt")
captions_embeddings_file = os.path.join(base_path, "8k_pretrain_caption_embeddings.pt")

def setup_logging(log_directory=base_path, log_file="mmrcs8k.log"):
    """
